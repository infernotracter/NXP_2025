...
{
    spi_init(IPS114_SPIN_PIN, IPS114_SCL_PIN, IPS114_SDA_PIN, IPS114_SDA_IN_PIN, IPS114_CS_PIN, 0, 50*1000*1000);//硬件SPI初始化
...
void ips114_showint32(uint16 x,uint16 y,int32 dat,uint8 num)
{
    ...
    ips114_showstr(x, y, (uint8 *)buff);	//显示数字
}
...
//  @return     void
//  @since      v1.0
//  Sample usage:               ips114_displayimage8660_zoom(scc8660_image[0], SCC8660_PIC_W, SCC8660_PIC_H, 160, 120);//显示彩色摄像头 图像
//  @note       图像的宽度如果超过液晶的宽度，则自动进行缩放显示。这样可以显示全视野
//-------------------------------------------------------------------------------------------------------------------
