...
#define IIC_SDA_PIN     IIC1_SDA_C3
#define IIC_SCL_PIN     IIC1_SCL_C2
//-------------------------------------------------------------------------------------------------------------------
//  @brief      ICM20602自检函数
//  @param      NULL
//  @return     void					
...
#define SPI_SCK_PIN     SPI2_SCK_C10    //接模块SPC
#define SPI_MOSI_PIN    SPI2_MOSI_C12   //接模块SDI
#define SPI_MISO_PIN    SPI2_MISO_C13   //接模块SDO
#define SPI_CS_PIN      SPI2_CS0_C11    //接模块CS
