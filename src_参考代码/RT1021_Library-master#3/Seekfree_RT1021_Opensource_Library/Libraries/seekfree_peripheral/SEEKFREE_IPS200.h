...
#define IPS200_SPIN             SPI_1           //定义使用的SPI号
#define IPS200_SCL_PIN_SPI      SPI1_SCK_B10 //定义SPI_SCK引脚
#define IPS200_SDA_PIN_SPI      SPI1_MOSI_B12 //定义SPI_MOSI引脚
#define IPS200_SDA_IN_PIN_SPI   SPI1_MISO_B13 //定义SPI_MISO引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
#define IPS200_CS_PIN_SPI       SPI1_CS0_B11  //定义SPI_CS引脚

// 如果使用的是单排排针的两寸屏幕 SPI 驱动控制引脚 可以修改
#define IPS200_RST_PIN_SPI      B8   // 液晶复位引脚定义
#define IPS200_DC_PIN_SPI       B9
#define IPS200_BL_PIN_SPI       B13


//引脚只能选择B C D这三个端口中的引脚，便于使用快速GPIO以提高显示速度
#define IPS200_RD_PIN_PARALLEL8  		B10
#define IPS200_WR_PIN_PARALLEL8  		B12
#define IPS200_RS_PIN_PARALLEL8  		B8
#define IPS200_RST_PIN_PARALLEL8 		B9
#define IPS200_CS_PIN_PARALLEL8  		B11
#define IPS200_BL_PIN_PARALLEL8  		B13
...
#define IPS200_D0_PIN_PARALLEL8 		C18
#define IPS200_D1_PIN_PARALLEL8 		C19
#define IPS200_D2_PIN_PARALLEL8 		C20
#define IPS200_D3_PIN_PARALLEL8 		C21
#define IPS200_D4_PIN_PARALLEL8 		C22
#define IPS200_D5_PIN_PARALLEL8 		C23
#define IPS200_D6_PIN_PARALLEL8 		C24
#define IPS200_D7_PIN_PARALLEL8 		C25
...
#define IPS200_DATA_PORT    2       //1：B端口  2：C端口  3：D端口
    ...
    #define IPS200_DATAPORT PORTB_DR	    //宏定义快速GPIO的输出寄存器
#elif( 2 == IPS200_DATA_PORT )
    #define IPS200_DATAPORT PORTC_DR	    //宏定义快速GPIO的输出寄存器
#elif( 3 == IPS200_DATA_PORT )
    #define IPS200_DATAPORT PORTD_DR	    //宏定义快速GPIO的输出寄存器
#endif
