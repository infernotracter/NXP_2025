...
void ips200_init(ips200_type_enum type_select)
{
    if(IPS200_TYPE_SPI == type_select)
    {
        ...
        gpio_init(IPS200_BL_PIN_SPI,GPO,1,GPIO_PIN_CONFIG);
        gpio_init(IPS200_DC_PIN_SPI,GPO,0,GPIO_PIN_CONFIG);
        gpio_init(ips_rst_pin,GPO,0,GPIO_PIN_CONFIG);
    }
    else
    {
        ips200_display_type = IPS200_TYPE_PARALLEL8;
        ips_rst_pin = IPS200_RST_PIN_PARALLEL8;
        gpio_init(IPS200_D0_PIN_PARALLEL8, GPO, 0, SPEED_200MHZ | DSE_R0 | PULLUP_47K | PULL_EN); 
        gpio_init(IPS200_D1_PIN_PARALLEL8, GPO, 0, SPEED_200MHZ | DSE_R0 | PULLUP_47K | PULL_EN);
        gpio_init(IPS200_D2_PIN_PARALLEL8, GPO, 0, SPEED_200MHZ | DSE_R0 | PULLUP_47K | PULL_EN);
        gpio_init(IPS200_D3_PIN_PARALLEL8, GPO, 0, SPEED_200MHZ | DSE_R0 | PULLUP_47K | PULL_EN);
        gpio_init(IPS200_D4_PIN_PARALLEL8, GPO, 0, SPEED_200MHZ | DSE_R0 | PULLUP_47K | PULL_EN);
        gpio_init(IPS200_D5_PIN_PARALLEL8, GPO, 0, SPEED_200MHZ | DSE_R0 | PULLUP_47K | PULL_EN);
        gpio_init(IPS200_D6_PIN_PARALLEL8, GPO, 0, SPEED_200MHZ | DSE_R0 | PULLUP_47K | PULL_EN);
        gpio_init(IPS200_D7_PIN_PARALLEL8, GPO, 0, SPEED_200MHZ | DSE_R0 | PULLUP_47K | PULL_EN); 
        
        gpio_init(IPS200_BL_PIN_PARALLEL8, GPO, 0, GPIO_PIN_CONFIG);
        gpio_init(IPS200_CS_PIN_PARALLEL8, GPO, 0, GPIO_PIN_CONFIG);
        gpio_init(ips_rst_pin, GPO, 0, GPIO_PIN_CONFIG);
        gpio_init(IPS200_RS_PIN_PARALLEL8, GPO, 0, GPIO_PIN_CONFIG);
        gpio_init(IPS200_WR_PIN_PARALLEL8, GPO, 0, GPIO_PIN_CONFIG);
        gpio_init(IPS200_RD_PIN_PARALLEL8, GPO, 0, GPIO_PIN_CONFIG);
	}
	IPS200_BL(1);
	IPS200_RST(0);	
	systick_delay_ms(5);		
