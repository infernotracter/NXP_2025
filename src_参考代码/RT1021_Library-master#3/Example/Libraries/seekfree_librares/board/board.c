...
void BOARD_InitDebugConsole(void)
{
    ...
    DbgConsole_Init(BOARD_DEBUG_UART_INSTANCE, DEBUG_UART_BAUD, kSerialPort_Uart, uartClkSrcFreq);
}
...
void BOARD_ConfigTCM(void)
{
    IOMUXC_GPR->GPR16 &= ~IOMUXC_GPR_GPR16_INIT_DTCM_EN_MASK;//关闭TCM
    IOMUXC_GPR->GPR16 &= ~IOMUXC_GPR_GPR16_INIT_ITCM_EN_MASK;
    
    IOMUXC_GPR->GPR17 = 0XAF55;
    
    IOMUXC_GPR->GPR14 &= ~IOMUXC_GPR_GPR14_CM7_CFGDTCMSZ_MASK;
    IOMUXC_GPR->GPR14 |= IOMUXC_GPR_GPR14_CM7_CFGDTCMSZ(7);
