...
//--------------引脚定义--------------
#define IPS114_SPIN_PIN        	SPI_1            //定义使用的SPI号
#define IPS114_SCL_PIN         	SPI1_SCK_B10     //定义SPI_SCK引脚
#define IPS114_SDA_PIN         	SPI1_MOSI_B12    //定义SPI_MOSI引脚
#define IPS114_SDA_IN_PIN      	SPI1_MISO_B13    //定义SPI_MISO引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
#define IPS114_CS_PIN          	SPI1_CS0_B11     //定义SPI_CS引脚
		
#define IPS114_BL_PIN          	B13	            //液晶背光引脚定义  由于实际通讯未使用B13因此 这里复用为GPIO控制BL引脚
#define IPS114_REST_PIN        	B8               //液晶复位引脚定义
#define IPS114_DC_PIN 	       	B9	            //液晶命令位引脚定义
