...
* 					------------------------------------
* 					模块管脚			单片机管脚
* 					SCL					查看 IPS114_SCL_PIN	宏定义的引脚	硬件SPI引脚不可随意切换
* 					SDA					查看 IPS114_SDA_PIN	宏定义的引脚	硬件SPI引脚不可随意切换
* 					RES					查看 IPS114_REST_PIN宏定义的引脚
* 					DC					查看 IPS114_DC_PIN	宏定义的引脚
* 					CS					查看 IPS114_CS_PIN	宏定义的引脚	硬件SPI引脚不可随意切换
* 					BLK					查看 IPS114_BL_PIN	宏定义的引脚
* 					电源引脚
* 					VCC					3.3V电源
* 					GND					电源地
* 					最大分辨率135*240
