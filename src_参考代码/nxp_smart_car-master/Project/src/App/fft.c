...
__ramfunc void conjugate_complex(int n,complex in[],complex out[])
{
	int i = 0;
	for(i=0;i<n;i++)
	{
...
__ramfunc float c_value(complex f)
{
...
//傅里叶变化
__ramfunc void fft(int length,complex f[])
{
	complex t,wn;//中间变量
	int i,j,k,m,n,l,r,M;
	int la,lb,lc;
...
//傅里叶逆变换
__ramfunc void ifft(int length,complex f[])
{
	int i=0;
