...
while len(device_list):
    ...
    rx_byte = iic3.readfrom(device_list[0], 1, True)
    print(rx_byte)

    iic3.readfrom_into(device_list[0], rx_buff, True)
    print(rx_buff)

    iic3.writeto(device_list[0], tx_buff, True)
    iic3.writevto(device_list[0], vectors, True)
