...
#define IMU963RA_SPC_PIN                            (SPI2_SCK_C10 )     // 硬件 SPI SCK 引脚
#define IMU963RA_SDI_PIN                            (SPI2_MOSI_C12)     // 硬件 SPI MOSI 引脚
#define IMU963RA_SDO_PIN                            (SPI2_MISO_C13)     // 硬件 SPI MISO 引脚
#define IMU963RA_CS_PIN                             (SPI2_CS0_C11)      // 硬件 CS 片选引脚
//====================================================硬件 SPI 驱动====================================================
#endif
