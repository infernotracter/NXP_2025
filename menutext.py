...
class MenuText:
    ...
    def show_main_menu(self):
        lcd.str24(48, 30, "ccd", 0xFFFF)
        lcd.str24(48, 54, "turn", 0xFFFF)
        lcd.str24(48, 78, "speed", 0xFFFF)
        lcd.str24(48, 102, "ring", 0xFFFF)
        lcd.str24(0, self.point, "8==D", 0xF800)
    ...
    def show_turn_menu(self):
        lcd.str16(16, 30, "turn out kp={:.3f}".format(-70.73+self.turn_out_kp_move), 0xFFFF)
