...
//	ANO_DT_Send_Data(data_to_send ,_cnt);
	UART4_PutBuff(data_to_send,_cnt);
}
void UART4_SendInt16(unsigned char Function, int outData1, int outData2, int outData3, int outData4, int outData5, int outData6, int outData7, int outData8)
{
	unsigned char sum;
