...
class CCDHandler:
    ...
    def get_mid_point(self, value, reasonrange):
        """获取中点"""
        for i in range(self.last_mid_point - 4, 1, -1):  # 用差比和公式判断是否找到边线
        ...
        # 搜索右边点，以上次中点作为这次的起搜点
        for i in range(self.last_mid_point+4, 126):  # 注意这里应该是128，因为索引是从0开始的
