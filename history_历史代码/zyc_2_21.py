...
gyro_pid = gyro_ring(kp = 10.0,ki=0.6)
...
def sec_menu_04():
    global main_point_item, main_menu_flag, angle_pd_flag, angle_pid.kp, angle_pid.kd
...
def sec_menu_05():
    global speed_pi_flag, main_menu_flag, main_point_item, speed_pid.kp, speed_pid.ki
...
def sec_menu_06():
    global main_point_item, main_menu_flag, gyro_pi_flag, gyro_pid.kp, gyro_pid.ki
