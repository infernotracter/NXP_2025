...
#         stop_flag=0
    ...
    if (ticker_flag_menu):
        ...
        if abs(openart_distance.data) > 300:
...
#                     balance_angle = data_wave[i]
        ...
        #vel_kp, vel_ki, vel_kd, angle_kp, vel_disturbance, angle_disturbance, current_angle
          elementdetector.state,speed_controller.target_speed, element_gyro.data, element_distance.data, ccd_controller.far , ccd_controller.follow 
