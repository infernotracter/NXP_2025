...
def menu(key_data):
#     lcd.str16(16,30,"speed_1=-30",0xFFFF)
#     lcd.str16(16,46,"speed_2=-40",0xFFFF)
#     lcd.str16(16,62,"speed_3=-50",0xFFFF)
#     lcd.str16(16,78,"fastest_peed=-65",0xFFFF)
#     lcd.str16(16,120,"target_speed={}".format(speed_controller.target_speed),0xFFFF)
    if key_data[0]:
        speed_controller.target_speed=-30
        speed_controller.tmp_speed=speed_controller.target_speed
        key.clear(1)
    if key_data[1]:
        speed_controller.target_speed=-40
        speed_controller.tmp_speed=speed_controller.target_speed
        key.clear(2)
    if key_data[2]:
        speed_controller.target_speed=-55
        speed_controller.tmp_speed=speed_controller.target_speed
        key.clear(3)
    if key_data[3]:
        speed_controller.target_speed=-65
        speed_controller.tmp_speed=speed_controller.target_speed
        key.clear(4)
...
#         else :
#             speed_controller.target_speed = int(speed_controller.tmp_speed * 1.0 )
#         if abs(alldistance.data)<2000:
#             speed_controller.target_speed = -20
...
#         # 将数据发送到示波器
        ...
        wireless.send_oscilloscope(
              vel_kp, vel_ki, vel_kd, angle_kp,   current_angle
#             elementdetector.state,speed_controller.target_speed,current_angle,encl_data,encr_data
